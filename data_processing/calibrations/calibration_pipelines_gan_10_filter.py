...
if __name__=="__main__":
    ...
    #base_file = r"C:\DCM\dcm-intuition\processes\data_processing\calibrations\quantamental_ml\prod_quantamental_ensemble_aws.conf"
    os_name = os.name
    print("Running on *********")
    if os.name=="nt":
        print("WINDOWS PLATFORM ")
        base_file = "C:/DCM/dcm-intuition/processes/data_processing/calibrations/quantamental_ml/prod_quantamental_gan_aws_10_filter_windows.conf"
    else:
        print("LINUX PLATFORM ")
        base_file = "/home/ec2-user/dcm-intuition/processes/data_processing/calibrations/quantamental_ml/prod_quantamental_gan_aws_10_filter.conf"
