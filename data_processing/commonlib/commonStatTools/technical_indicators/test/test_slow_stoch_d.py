...
from commonlib.commonStatTools.technical_indicators.offline import slow_stoch_d

input_dir = os.path.join(os.path.dirname(__file__), "input_data")
# So "test_slow_stoch_d.py" turns into "slow_stoch_d"...
...
def test_slow_stoch_d(price_data, expected_data):
    results = slow_stoch_d(price_data["Adj Close"])
