...
from commonlib.commonStatTools.technical_indicators.offline import rate_of_change

input_dir = os.path.join(os.path.dirname(__file__), "input_data")
# So "test_rate_of_change.py" turns into "rate_of_change"...
...
def test_rate_of_change(price_data, expected_data):
    results = rate_of_change(price_data["Adj Close"])
