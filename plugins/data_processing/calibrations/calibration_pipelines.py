...
if __name__=="__main__":
    ...
    #base_file = r"C:\DCM\dcm-intuition\processes\data_processing\calibrations\quantamental_ml\prod_quantamental_ensemble_local.conf"
    #base_file = r"C:\DCM\dcm-intuition\processes\data_processing\calibrations\quantamental_ml\quantamental_with_econ_full_gan_training_aws_first.conf"
    base_file = r"/home/p3mig/dcm_py3p6/dcm-intuition/processes/data_processing/calibrations/fundamental_rebalancing_trader/fundamental_rebalancing_calibration.conf"
    #flow_file = r"C:\DCM\dcm-intuition\processes\data_processing\calibrations\views_in_market_trading\market_view_calibration_simplified.conf"
    ...
    #TaskflowPipelineDescriptionBuilder.build_flow_from_scratch(["MergeAllData", "GenerateKMeansClusters"], flow_file)
    ...
    #target_dt = pd.Timestamp("2020-01-24")
    #start_dt = pd.Timestamp("2018-01-03")
    #target_dt = pd.Timestamp("2018-08-01")
    #start_dt = pd.Timestamp("2018-02-01")

    target_dt = pd.Timestamp("2020-06-15")
    ...
    # Live
    #flow_parameters = BasicTaskParameters(pd.Timestamp("2019-01-04"), pd.Timestamp("2017-09-27"), target_dt, pd.Timestamp("2019-01-03"),
    #                                      TaskflowPipelineRunMode.Calibration)
