...
from commonlib.commonStatTools.technical_indicators.offline import KaufmanMA

input_dir = os.path.join(os.path.dirname(__file__), "input_data")
# So "test_KaufmanMA.py" turns into "KaufmanMA"...
...
def test_KaufmanMA(price_data, expected_data):
    results = KaufmanMA(price_data["Adj Close"])
