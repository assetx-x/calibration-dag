...
TrainGANModel_params = {
    'params': train_gan_params,
    'class': TrainGANModel,
    'start_date': RUN_DATE,
    'provided_data': {
        'gan_model_save_info': construct_destination_path('gan_training'),
    },
    'required_data': {},
}
