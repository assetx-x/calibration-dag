...
class QuantamentalMerge(DataReaderClass):
    ...
    REQUIRES_FIELDS = ["daily_price_data", "fundamental_features", 'overnight_return_data',
                       "security_master"]
    ...
    def do_step_action(self, **kwargs):
        ...
        try:
            ...
            for i, df in enumerate([fundamental_features]):
            ...
            # merged_data["ARE_beta"] = merged_data["ARE_beta"].astype(float)
