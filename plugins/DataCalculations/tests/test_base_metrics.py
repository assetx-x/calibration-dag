...
class TestBaseMetrics(unittest.TestCase):
    ...
    def test_validate_empty_dataframe(self):
        ...
        self.assertTrue('Please implement this method in your subclass' in str(context.exception))
    ...
    def test_calculate_method(self):
        ...
        with patch('logging.info') as mock_logging:
            ...
            mock_logging.assert_called_with('[*] Calculating calculate_calculate_example from BaseMetrics')
