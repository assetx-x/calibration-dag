...
class GenerateDataGANWeekly(GenerateDataGAN):
    ...
    REQUIRES_FIELDS = ["normalized_data_full_population", "normalized_data_full_population_weekly", "econ_data_final",
                       "econ_data_final_weekly", "future_returns_bme", "future_returns_weekly", "active_matrix",
    ...
    def do_step_action(self, **kwargs):
        ...
        self.gan_data_info = pd.DataFrame([self.data_dir], columns=["relative_path"])
        return {'company_data': self.data, 'company_data_weekly': self.weekly_data, 'gan_data_info': self.gan_data_info}
...
GenerateDataGANWeekly_params = {'params': GDGW_params2,
                                ...
                                'required_data': {
                                    ...
                                    'normalized_data_full_population_weekly': construct_required_path('standarization',
                                                                                                      'normalized_data_full_population_weekly'),
                                    'econ_data_final': construct_required_path('merge_econ', 'econ_data_final'),
                                    'econ_data_final_weekly': construct_required_path('merge_econ',
                                                                                      'econ_data_final_weekly'),
                                    'future_returns_bme': construct_required_path('additional_gan_features',
                                                                                  'future_returns_bme'),
                                    'future_returns_weekly': construct_required_path('additional_gan_features',
                                                                                     'future_returns_weekly'),
                                    'active_matrix': construct_required_path('active_matrix', 'active_matrix'),
                                    'active_matrix_weekly': construct_required_path('active_matrix',
                                                                                    'active_matrix_weekly'),
