...
class FactorStandardizationFullPopulationWeekly(FactorStandardization):
    ...
    def do_step_action(self, **kwargs):
        ...
        self.data = factor_standarization(monthly_df, all_features, self.target_columns, self.exclude_from_standardization)
        self.weekly_data = factor_standarization(weekly_df, all_features, self.target_columns, self.exclude_from_standardization)
        return {'normalized_data_full_population':self.data,'normalized_data_full_population_weekly':self.weekly_data}
...
FactorStandardizationFullPopulationWeekly_params = {'params':FSFPW_params,
                                       ...
                                       'start_date':RUN_DATE,
                                'provided_data': {'normalized_data_full_population': construct_destination_path('standarization'),
                                                  'normalized_data_full_population_weekly': construct_destination_path('standarization')},
                                'required_data': {'merged_data_econ_industry':construct_required_path('merge_econ','merged_data_econ_industry'),
                                                  'merged_data_econ_industry_weekly': construct_required_path('merge_econ','merged_data_econ_industry_weekly')}}
